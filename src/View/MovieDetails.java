...
public class MovieDetails extends javax.swing.JFrame {
    ...
    controller = new MovieDetailsController(this,model);
}

    public void autoId() {
        try {
        String nextId = MovieModel.AutoMovieId();
        jLabel10.setText(nextId);
    ...
    public void tbload() {
        ...
        MovieModel.loadMovieDetails(dt);
    } catch (SQLException ex) {
        Logger.getLogger(MovieDetails.class.getName()).log(Level.SEVERE, null, ex);
    } catch (ClassNotFoundException ex) {
        Logger.getLogger(MovieDetails.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "GHOSTBUSTERS: FROZEN EMPIRE", "GODZILLA X KONG: THE NEW EMPIRE", "KUNG FU PANDA 4", "FURIOSA: A MAD MAX SAGA" }));
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "GAMPAHA", "COLOMBO", "KIRIBATHGODA" }));
        ...
        jComboBox4.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "10.30 am", "1.30 pm", "4.30 pm", "9.00 pm" }));
        ...
        btnBook.setBackground(new java.awt.Color(0, 0, 102));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Movie_ID", "MOIVE", "LOCATION", "Date", "TIME", "NO OF TICKETS"
            }
        ) {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(btnBook, javax.swing.GroupLayout.PREFERRED_SIZE, 484, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
